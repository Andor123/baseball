function showTable7(ajax) {
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            if (ajax == 23) {
                $('#table23').fadeOut(400, function () {
                    $('#table23').html(response.html).fadeIn();
                });
            }
            if (ajax == 24) {
                $('#table24').fadeOut(400, function () {
                    $('#table24').html(response.html).fadeIn();
                });
            }
            if (ajax == 25) {
                $('#table25').fadeOut(400, function () {
                    $('#table25').html(response.html).fadeIn();
                });
            }
            if (ajax == 26) {
                $('#table26').fadeOut(400, function () {
            ...
            if (ajax == 28) {
                $('#table28').fadeOut(400, function () {
                    $('#table28').html(response.html).fadeIn();
                });
            }
        },
